...
public class Speech_Cameraopen_objectdetection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_speech_cameraopen_objectdetection);
    ...
    private void detectBreedUsingGroq(String base64Image) {
        ...
        try {
            ...
            textPart.put("text", "What breed or object is in this image? Just return the name.");
